...
class Iconos
{
    ...
    public function getIconosProductos($id)
    {
        $stmt = $this->db->prepare("SELECT * FROM iconos a INNER JOIN items_producto b ON a.id_icono=b.id_icon WHERE b.id_producto = :id");
    ...
    public function update($id, $data)
    {
        ...
        $stmt = $this->db->prepare("UPDATE " . $this->table . " SET " . implode(',', $sets) . " WHERE id_icono = ?");
