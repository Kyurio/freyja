...
class Questions
{
    ...
    public function GetAll()
    {
        try {
            ...
            $stmt = $this->db->prepare("SELECT * FROM " . $this->table . " ORDER BY id_pregunta DESC");
            $stmt->execute();
    ...
    public function update($id, $data)
    {
        try {
            ...
            $stmt = $this->db->prepare("UPDATE " . $this->table . " SET " . implode(',', $sets) . " WHERE id_pregunta = ?");
    ...
    public function delete($id)
    {
        ...
        try {
            ...
            $stmt = $this->db->prepare("DELETE FROM " . $this->table . " WHERE id_pregunta = ?");
