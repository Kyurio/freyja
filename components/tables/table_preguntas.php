...
<div class="pagination">
    <button class="btn btn-dark btn-sm" :disabled="currentPage === 1" @click="prevPage">Anterior</button>
    <span>{{ currentPage }}</span>
    <button class="btn btn-dark btn-sm" :disabled="currentPage === totalPages" @click="nextPage">Siguiente</button>
</div>