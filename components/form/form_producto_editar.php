<div class="container py-5 mx-5 mt-2">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form @submit.prevent="validateFormEdit" enctype="multipart/form-data" novalidate="true"
                v-if="FlagProducto == false">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="producto" placeholder="Nombre Producto"
                                v-model="requestDataProducto.producto">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-floating">
                        <textarea class="form-control" placeholder="Leave a comment here" id="descripcion"
                            v-model="requestDataProducto.descripcion"></textarea>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-floating">
                        <textarea class="form-control" placeholder="Leave a comment here" id="item"
                            v-model="requestDataProducto.item"></textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" min="1" class="form-control" id="precio" placeholder="Precio"
                                v-model="requestDataProducto.precio">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" min="1" class="form-control" id="stock" placeholder="Stock"
                                v-model="requestDataProducto.stock">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" multiple class="form-control" id="imagenes" name="imagenes[]" accept="image/*"
                        ref="inmagenesInput" v-model="requestDataProducto.url">
                ...
                <div class="mt-5 mb-5">
                    ...
                    <div v-for="(item, index) in iconos">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" :value="item.id_icono"
                                :id="'icon-' + item.id_icono" v-model="elementosSeleccionados">
            ...
            <div class="progress" role="progressbar" aria-label="Carga de imágenes" aria-valuenow="0" aria-valuemin="0"
